...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Globe " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"mainnet.globe.pw", "seed.mainnet.globe.pw"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.globe.pw", "seed.testnet.globe.pw"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Globe is probably already running."), addrBind.ToString().c_str());
        else
