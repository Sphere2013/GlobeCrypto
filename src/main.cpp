...
uint256 hashGenesisBlock("0x000000008b829d2bbf6d1ffc14a3aaff980748ab18d3038a0a6c0bc9fb86207b");
...
const string strMessageMagic = "Globe Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000d70ff1a76ad07a2be307fc2ece9f42993dd2b3d1668d9cca0ab0f395");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "LA Times 29/Oct/2013 China Leaders were nearby apparent Tiananmen Square attack";
        CTransaction txNew; 
        txNew.nVersion = 2;
        txNew.nRefHeight = 0;
        txNew.vin .resize(1);
...
\xef\xbe\x8c\xe3\x80\x80\xe3\x80\x80\xe3\x80\x80  /\xe3\x83\xbd \xe3\x83\xbd_\xef\xbc\x8f\xef\xbc\x8f";
        ...
        txNew.vout[3].scriptPubKey = CScript()
            ...
            << OP_EQUALVERIFY
            << OP_CHECKSIG;
        const char* pszMessage4 = "Ich w\xc3\xbc""nsche Globe viel Erfolg zum Nutzen der 99 Prozent!";
        ...
        block.nVersion = 1;
        block.nTime    = 1385247468;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 3271287052;

        if (fTestNet)
        {
            block.nTime    = 1383052488;
            block.nNonce   = 133085377;
        }         
        ...
        assert(block.hashMerkleRoot == uint256("0xd89148ec7c56eb238d451eea881039edc860e4ba2e12cd3e23ea3ed368294ead"));
        block.print();
